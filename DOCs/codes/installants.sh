...
Please see post installation instructions at 
  $antsBuildInstructions
"
# Set ANTSPATH and PATH for current session and future sessions

export ANTSPATH=$installDir/bin

export PATH=${ANTSPATH}:$PATH



# Append exports to .bashrc for persistence across sessions

echo "export ANTSPATH=$installDir/bin" >> ~/.bashrc
...
ANTSPATH and PATH environment variables have been set for this session and added to ~/.bashrc for future sessions.
